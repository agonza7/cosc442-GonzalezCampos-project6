...
WebUI.setText(findTestObject('Page_Supplier Login (1)/input_email'), 'supplier@failedattempt.com')

WebUI.setText(findTestObject('Page_Supplier Login (1)/input_password'), 'failtest')
